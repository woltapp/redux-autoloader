      ...
      return (
        ...
        >
          ...
          >
            ...
            <button
              type="button"
              onClick={() => this.setState({ mounted: !mounted })}
            >
          ...
          <div style={{ marginTop: 20 }}>
            {mounted ? (
              ...
              <span style={{ color: '#777' }}>[loader unmounted]</span>
            )}
          </div>
        </div>
      );
...
const LoaderView1 = createMounter(
  'Loader 1 (auto refresh in 2000ms)',
  reduxAutoloader({
    name: 'demo-loader-1',
...
const LoaderView2 = createMounter(
  'Loader 2 (no reload on mount)',
  reduxAutoloader({
    name: 'demo-loader-2',
...
const LoaderView3 = createMounter(
  'Loader 3 (no initial auto refresh)',
  reduxAutoloader({
    name: 'demo-loader-3',
...
const LoaderView4 = createMounter(
  'Loader 4 (autorefresh start and load prevented on mount)',
  reduxAutoloader({
    name: 'demo-loader-4',
